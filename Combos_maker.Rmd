...
This script uses as 2 .csv files containing the number, positions, and identities of FISH probes (Green, Red, Blue) to be picked from an arbitrary number of 96-well source plates. The probes are dispensed in a 96-well plate containing 3-way combinations. The scripts outputs a .csv file containing the dispense operations for the Janus.  
...
combos_template <- data.table(combos_rack = rep(paste0("combos_rack_", 
                                                     1:n_combos_rack), 
                                              each = 60),
                             combos_pos = as.vector(outer((10:15), seq(0, 72, 8), FUN = "+")), # Only inner wells (60)
